...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// username
			// 
			this->username->Location = System::Drawing::Point(168, 55);
			...
			// password
			// 
			this->password->Location = System::Drawing::Point(168, 96);
			...
			this->label1->Location = System::Drawing::Point(87, 58);
			...
			this->label2->Location = System::Drawing::Point(87, 99);
			...
			// registerBtn
			// 
			this->registerBtn->Location = System::Drawing::Point(289, 96);
			this->registerBtn->Name = L"registerBtn";
			this->registerBtn->Size = System::Drawing::Size(71, 20);
			...
			this->linkLogin->LinkColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(192)),
				static_cast<System::Int32>(static_cast<System::Byte>(192)));
			this->linkLogin->Location = System::Drawing::Point(152, 129);
			this->linkLogin->Name = L"linkLogin";
			this->linkLogin->Size = System::Drawing::Size(132, 13);
			this->linkLogin->TabIndex = 5;
			this->linkLogin->TabStop = true;
			this->linkLogin->Text = L"Already have an account\?";
			...
			this->ClientSize = System::Drawing::Size(428, 218);
